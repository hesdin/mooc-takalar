  ...
  <div class="aside-menu flex-column-fluid ps-3 ps-lg-5 pe-1 mb-9" id="kt_aside_menu">
    ...
    <div class="w-100 hover-scroll-overlay-y pe-2 me-2" id="kt_aside_menu_wrapper" data-kt-scroll="true"
      ...
      <div class="menu menu-column menu-rounded fw-bold" id="#kt_aside_menu" data-kt-menu="true">
        <div class="menu-item">
          <a class="menu-link" href="{{ route('guru.dashboard') }}">
        ...
        <div data-kt-menu-trigger="click" class="menu-item">
          ...
          <div class="menu-sub menu-sub-accordion">
            <div class="menu-item">
              <a class="menu-link" href="{{ route('guru.dashboard.mycourse') }}">
            ...
            <div class="menu-item">
              <a class="menu-link" href="{{ route('guru.dashboard.allcourse') }}">
                <span class="menu-bullet">
                  <span class="bullet bullet-dot"></span>
                </span>
                <span class="menu-title">Semua Kursus</span>
              </a>
            </div>
          </div>
        </div>
    ...
    <div class="d-flex flex-stack ms-7">
      ...
      <div class="ms-1">
        ...
        <div
          ...
          <div class="menu-item px-3">
            <div class="menu-content d-flex align-items-center px-3">
              ...
              <div class="d-flex flex-column">
                <div class="fw-bolder d-flex align-items-center fs-5">{{ Auth::guard('guru')->user()->nama }}
                  <span
                    class="badge badge-light-dark fw-bolder fs-8 px-2 py-1 ms-2">{{ Auth::guard('guru')->user()->nip }}</span>
                </div>
                <a href="#"
                  class="fw-bold text-muted text-hover-primary fs-7">{{ Auth::guard('guru')->user()->email }}</a>
              </div>
              <!--end::Username-->
            </div>
          </div>
          ...
          <!--begin::Menu item-->
          <div class="menu-item px-5">
            <a href="{{ route('logout') }}" class="menu-link px-5">Log
              Out</a>
          </div>
          <!--end::Menu item-->
          <!--begin::Menu separator-->
