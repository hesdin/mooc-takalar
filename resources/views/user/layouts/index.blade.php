      ...
      <div class="modal-content">
        ...
        <div class="collapse show" id="collapseSignin" data-bs-parent="#accountModal">
          <div class="modal-header">
            <h5 class="modal-title">Hallo {{ Auth::guard('guru')->user()->nama }}!</h5>
          ...
          <div class="modal-body">
            <a href="{{ route('guru.dashboard') }}" class="btn btn-block btn-primary">
              DASHBOARD
            </a>

            <a href="{{ route('logout') }}" class="btn btn-block btn-danger mt-3 text-white">
              LOGOUT
            </a>
