<header class="navbar navbar-expand-xl navbar-light py-0">
  <div class="container container-wd">
    ...
    <ul class="navbar-nav navbar-vertical ms-xl-4 d-none d-xl-flex">
      <li class="nav-item">
        <a class="nav-link text-dark pb-4 mb-n4 px-0 pt-0" id="navbarVerticalMenu" data-bs-toggle="dropdown"
    ...
    <div class="collapse navbar-collapse z-index-lg" id="navbarCollapse">
      ...
      <ul class="navbar-nav ms-5">
        <li class="nav-item dropdown dropdown-full-width">
          <a class="nav-link text-dark dropdown-toggle px-xl-4" id="navbarLandings" data-bs-toggle="dropdown"
            href="#" aria-haspopup="true" aria-expanded="false">
            Pembelajaran Saya
          </a>
    ...
    <ul class="navbar-nav flex-row ms-auto ms-xl-0 me-n2 me-md-n4">
      <li class="nav-item border-0 px-0 d-none d-370-block d-xl-none">
        <a class="nav-link text-dark d-flex px-3 px-md-4 search-mobile text-secondary" data-bs-toggle="collapse"
      ...
      <li class="nav-item border-0 px-0">
        ...
        @if (Auth::guard('guru')->check())
          <a href="#" class="nav-link text-dark d-flex px-3 px-md-4 text-secondary" data-bs-toggle="modal"
            data-bs-target="#accountModal">
            <!-- Icon -->
            <svg width="30" height="30" viewBox="0 0 20 20" fill="none"
              xmlns="http://www.w3.org/2000/svg" class="text-dark">
              <path
        ...
        @else
          <a href="{{ route('login') }}" class="nav-link text-dark d-flex px-3 px-md-4 text-secondary">
            <!-- Icon -->
            <svg width="30" height="30" viewBox="0 0 20 20" fill="none"
              xmlns="http://www.w3.org/2000/svg" class="text-dark">
              <path
