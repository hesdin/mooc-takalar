    ...
    <div class="container-fluid" id="kt_content_container">
      ...
      <div class="card">
        ...
        <div class="card-body py-4">
          <!--begin::Table-->
          <table id="kt_datatable_example_1" class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer">
            <thead>
            ...
            <tbody class="fw-bold text-gray-800 ">
              @foreach ($quizzes as $quiz)
                <tr>
                  ...
                  <td>
                    <span class="">{{ Carbon\Carbon::parse($quiz->created_at)->isoFormat('DD MMMM YYYY') }}
                    </span>
                  </td>
                      ...
                      <div class="menu-item px-3">
                        <form id="delete-form-{{ $quiz->id }}"
                          ...
                          <a href="#" class="menu-link px-3 showConfirm"
                            data-kt-ecommerce-product-filter="delete_row" data-name="{{ $quiz->title }}">Delete</a>
                        </form>
                      </div>
                      <!--end::Menu-->
                  </td>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="editModal{{ $quiz->id }}Label">Edit Pre Test</h5>
                      ...
                      <form action="{{ route('instruktur.pre-test.update', $quiz->id) }}" method="POST">
                        ...
                        <div class="modal-body">
                          <div class="form-group">
                            <label for="edit_title{{ $quiz->id }}">Judul Kuis:</label>
                            <input type="text" class="form-control" id="edit_title{{ $quiz->id }}"
                              name="title" value="{{ $quiz->title }}" required>
                          </div>
                        </div>
...
<div class="modal fade" tabindex="-1" id="kt_modal_1">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Tambah Pre Test</h5>
      ...
      <form action="{{ route('instruktur.pre-test.store') }}" method="post">
        ...
        <div class="modal-body">
          <div class="mb-10">
            <label for="course" class="required form-label">Kursus</label>
