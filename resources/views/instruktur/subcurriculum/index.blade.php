                ...
                <tr>
                  ...
                  <td class="text-start pe-0" data-order="Scheduled">
                    ...
                    <div class="badge badge-light-primary">
                      {{ Str::contains($subcurriculum->content, ['.pdf', '.ppt', '.pptx']) ? 'Dokumen' : 'Link' }}</div>
                    <!--end::Badges-->
                  </td>
                  <!--begin::Action=-->
                  <td class="text-end">
                    ...
                    <div
                      ...
                      <div class="menu-item px-3">
                        <form id="delete-form-{{ $curriculum->id }}"
                          action="{{ route('instruktur.courses.curriculum.subcurriculum.destroy', ['course' => $course->id, 'curriculum' => $curriculum->id, 'subcurriculum' => $subcurriculum->id]) }}"
    ...
    <div class="modal fade" tabindex="-1" id="kt_modal_1">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form
            action="{{ route('instruktur.courses.curriculum.subcurriculum.store', ['course' => $course->id, 'curriculum' => $curriculum->id]) }}"
            method="post" enctype="multipart/form-data">
            @csrf
            <div class="modal-body">
              <div class="mb-10">
                <label for="order" class="required form-label">Urutan</label>
                <input type="number" class="form-control" name="order" id="order" placeholder="" required />
              </div>
              <div class="mb-10">
              ...
              <div class="mb-10">
                ...
                <input type="text" class="form-control" name="content" id="content" placeholder="" required />
              </div>
            </div>
  ...
  <script>
    ...
    $('#tipe').on('change', function() {
      if (this.value == "link") {
        ...
        // $('#content').attr('accept', '.pdf, .ppt, .pptx');
